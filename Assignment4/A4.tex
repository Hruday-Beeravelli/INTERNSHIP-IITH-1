...
\subsection{Solution}
\begin{align}
& \frac{1}{2}\mydet{\myvec{\vec{A}-\vec{B}}&\myvec{\vec{A}-\vec{C}}}
\label{eq5}
\end{align}
...
\begin{align}
&=\frac{1}{2}\mydet{\frac{9}{2}&\frac{15}{2}\\-3&-5}\\
&=\frac{1}{2}\left[\myvec{\frac{9}{2}\times-5}-\myvec{\frac{15}{2}\times-3}\right]\\
&=\frac{1}{2}\myvec{-\frac{45}{2}+\frac{45}{2}}\\
&=\frac{1}{2}\myvec{0}\\
&=0\nonumber
\end{align}
Since the area is $0$, the given points form a straight line.
\begin{figure}[!ht]
